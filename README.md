...
* Travis CI:
    ...
    * "release" branch [![Build Status](https://travis-ci.org/aws-robotics/kinesisvideo-common.svg?branch=release-v2)](https://travis-ci.org/aws-robotics/kinesisvideo-common/branches)
* ROS build farm:
