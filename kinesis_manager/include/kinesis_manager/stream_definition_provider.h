...
public:
   ...
   * @param prefix a list of strings representing the path of the parameter's prefix.
   ...
   * was provided
   */
  virtual KinesisManagerStatus GetCodecPrivateData(const std::vector<std::string> & prefix,
   ...
   */
  virtual unique_ptr<StreamDefinition> GetStreamDefinition(const std::vector<std::string> & prefix,
                                                           const ParameterReaderInterface & reader,
